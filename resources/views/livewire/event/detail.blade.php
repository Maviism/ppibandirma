            ...
            <div>
                ...
                <article class="p-2">
                    <div class="flex items-center mb-4 space-x-4">
                        <img class="w-10 h-10 rounded-full" src="{{ $rating->show_name == 1 ? $rating->user->profile_photo_url : '/logo.png' }}" alt="">
                        <div class="space-y-1 font-medium">
                            <p>{{ $rating->show_name == 1 ? $rating->user->name : 'Anonim'}} <time datetime="2017-03-03 19:00" class="text-sm text-gray-500">. March 3, 2017</time>
