        ...
        <div class="container my-8 px-2 pb-1 shadow-xl">
          <div class="flex justify-between items-center mb-4">
            <h2 class="text-3xl font-medium">
              Upcoming Event
              <a href="#" class=""><span class="text-salmon font-medium text-lg ml-2 hover:underline">See all</span></a>
            </h2>
            <div>
              <button class="cursor-pointer text-xl mx-1 text-indigo-600 font-bold">
                <<
              </button>
              <button class="cursor-pointer text-xl mx-1 text-indigo-600 font-bold">
                >>
