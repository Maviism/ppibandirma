<div>
        ...
        <div class="grid lg:grid-cols-2 flex items-center">
          <div class="md:mt-12 lg:mt-0 mb-12 lg:mb-0">
            <div class="block rounded-lg shadow-lg px-6 py-12 md:px-12 lg:-mr-14" style="background: hsla(0, 0%, 100%, 0.55); backdrop-filter: blur(30px);">
              <h1 class="text-4xl md:text-5xl xl:text-6xl font-bold tracking-tight mb-12">The best offer <br /><span class="text-blue-600">for your business</span></h1>
              ...
              <a class="inline-block px-7 py-3 bg-transparent text-blue-600 font-medium text-sm leading-snug uppercase rounded hover:text-blue-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light" href="#!" role="button">Our Event</a>
            </div>
          </div>
	...
	<section class="mb-32 text-gray-800 p-5 text-center">
		<h2 class="text-3xl font-bold mb-20">Our Teams</h2>
		...
		<div class="grid lg:gap-x-8 lg:grid-cols-3">
			...
			<div class="mb-12">
				...
				<div class="flex justify-center">
					<div class="bg-blue-600 rounded-full shadow-lg inline-block -mt-8">
						<img src="bebek.jpg" class=" w-24 h-24 rounded-full object-cover" alt="">
					</div>
				</div>
				<div class="p-6">
					<h3 class="text-2xl font-bold text-blue-600">Bebek Kuning</h3>
					<h5 class="text-lg font-medium mb-4 text-gray-500">Pembantu umum</h5>
					<q class="text-gray-500 italic">
