<div>
	...
	<section class="text-center p-2 bg-white m-2 rounded h-auto">
		<p class="font-black text-transparent bg-clip-text bg-gradient-to-b from-blue-700 to-gray-300 mt-5 p-3">Hymne PPI Bandirma</p>
	...
	<section class="mb-32 text-gray-800 p-5" id="event">
		...
		<h2 class="text-3xl font-bold mb-12 text-center">Our Event</h2>
		...
		<div class="flex flex-wrap items-center">
			...
			<div class="flex flex-wrap pt-12 lg:pt-0">
				...
				<div class="flex items-start">
					...
					<div class="grow ml-6">
					<p class="font-bold mb-1">Advokasi PPI Bandirma</p>
				...
				<div class="mb-12 lg:mb-0 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
					<div class="flex align-start">
						...
						<p class="text-gray-500">muadzihharul@gmail.com</p>
						<p class="text-gray-500">+90 552 591 12 15</p>
						</div>
					</div>
				</div>
