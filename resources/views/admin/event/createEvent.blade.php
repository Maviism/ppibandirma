      ...
      <div class="card card-primary">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="eventPlace" name="eventPlace" value="{{ old('eventPlace') }}" placeholder="Masukan tempat acara">
                @error('eventPlace')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group">
              ...
              <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                  <input type="text" required name="eventDate" placeholder="dd/mm/yyyy 00:00" value="{{ old('eventDate') }}" class="form-control datetimepicker-input" data-target="#reservationdatetime"/>
